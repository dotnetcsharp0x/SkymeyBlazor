...
namespace SkymeyBlazor.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<DateTime> LoginAsync(SU_001LoginViewModel model)
        {
            var response = await _factory.CreateClient("ServerApi").PostAsync("api/User/Login",
        ...
        public async Task<bool> RefreshAsync()
        {
            ...
            var response = await _factory.CreateClient("ServerApi").PostAsync("api/User/Refresh",
                                                        JsonContent.Create(model));
